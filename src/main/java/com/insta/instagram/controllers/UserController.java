...
public class UserController {
	...
	@GetMapping("/id/{uid}")
	public ResponseEntity<User> findUserById ( @PathVariable(name = "uid") Integer id) throws UserException{
	...
	public ResponseEntity<MessageResponse> followUser (@PathVariable Integer followUserId, @RequestHeader("Authorization") String token) throws UserException {
	...
	public ResponseEntity<MessageResponse> unfollowUser (@PathVariable Integer followUserId, @RequestHeader("Authorization") String token) throws UserException {
		User user = userService.findUserProfile(token);
	...
	@GetMapping("/search")
	public ResponseEntity<List<User>> searchUser (@RequestParam(name = "q") String query) throws UserException {
